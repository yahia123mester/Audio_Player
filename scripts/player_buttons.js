class Player{
    constructor(){
        ...
        this.audios =[];
        this.audios[0] = "./audio/Maid_with_the_Flaxen_Hair.mp3";
        this.audios[1] = "./audio/music.mp3";
        this.audios[2] = "./audio/Kalimba.mp3";
    
        this.names = [];
        this.names[0] = "Maid with the Flaxen Hair";
        this.names[1] = "Kurdish Music";
        this.names[2] = "Kalimba";
